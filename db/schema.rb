...
ActiveRecord::Schema.define(version: 2021_03_18_035523) do
  ...
  add_foreign_key "naver_projects", "navers", on_delete: :cascade
  add_foreign_key "naver_projects", "projects", on_delete: :cascade
